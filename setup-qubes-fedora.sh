...
dnf install --allowerasing bash-color-prompt bind-utils butane default-fonts fcitx5-anthy fcitx5-autostart fedora-flathub-remote ffmpeg fuse-sshfs helm htop kubernetes1.35-client netcat qubes-ctap ShellCheck tigervnc toolbox whois xdg-desktop-portal-gtk
