...
all_proxy=127.0.0.1:8082 bash install-desktop-flatpaks.sh
all_proxy=127.0.0.1:8082 flatpak install org.keepassxc.KeePassXC org.virt_manager.virt-manager
