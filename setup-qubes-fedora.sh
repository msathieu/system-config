...
dnf install --allowerasing bash-color-prompt bind-utils default-fonts fcitx5-anthy fcitx5-autostart fedora-flathub-remote ffmpeg git helm kubernetes1.36-client netcat nix qubes-ctap ShellCheck tigervnc toolbox vim-enhanced xdg-desktop-portal-gtk
