...
rpm-ostree install --idempotent akmod-nvidia nvidia-container-toolkit ramalama rpmfusion-free-release rpmfusion-nonfree-release steam-devices xorg-x11-drv-nvidia xorg-x11-drv-nvidia-cuda
